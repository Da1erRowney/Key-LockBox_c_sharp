    ...
    public partial class Setting : ContentPage
    {
        ...
        private void CheckHintsBasics()
        {
            ...
            if (currentUser.HintsSetting == "NoN")
            {
                ...
                DisplayAlert("Подсказка", "Здесь вы можете изменить данные своей учетной записи, добавить пинкод для дальнейшего входа, сменить пользовательскую тему и выйти из аккаунта.", "OK");
                DisplayAlert("Подсказка", "Принудительно вас просим создать собственный пинкод. Для этого нажмите Изменить данные учетной записи -> подтвердите свои данные и введите пинкод. ", "OK");
